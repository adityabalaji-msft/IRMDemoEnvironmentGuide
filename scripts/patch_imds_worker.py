path = '/opt/scenario6-vm-worker/src/index.js'
with open(path, 'r') as f:
    content = f.read()

# Check if already patched
if 'refreshZoneFromIMDS' in content:
...
"""
    ...
    if marker in content:
        ...
        marker2 = "let VM_NAME = process.env.VM_NAME || os.hostname();"
        content = content.replace(marker2, marker2 + imds_block)
